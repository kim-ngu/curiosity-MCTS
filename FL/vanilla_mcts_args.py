...
def parse_args():
    ...
    # Training
    parser.add_argument("--vae-n-epochs", type=int, default=5)
    ...
    parser.add_argument("--rnn-n-steps", type=int, default=128) # 128
    ...
    parser.add_argument("--rnn-input-size", type=int, default=32) # z-state
